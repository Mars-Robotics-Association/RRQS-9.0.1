...
public final class AutoBlueBackStage extends LinearOpMode {
    ...
    public static int DEFAULT_ZONE  = 0 ;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        MecanumDrive drive = new MecanumDrive(hardwareMap,
                new Pose2d(12, 64, Math.toRadians(90)));
        ...
        switch (myZone) {
            ...
            case 0: // Left
                Actions.runBlocking(
                        drive.actionBuilder(drive.pose)
                                .setReversed(true)
                                .splineTo(new Vector2d(19, 36), Math.toRadians(-60))
                                .stopAndAdd( robot.raiseArm(1) )
                                .setReversed(false)
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        ...
                        .splineTo(new Vector2d(48, 60), Math.toRadians(0))
                        .build());
