...
@TeleOp(name="Blue-FrontStage", group="Erik CenterStage")
public final class AutoBlueFrontStage extends LinearOpMode {
        ...
        switch (myZone) {
            case 2: // Right
                Actions.runBlocking(
                        drive.actionBuilder(drive.pose)
                            .setReversed(true)
                            .splineTo(new Vector2d(-39, 30), Math.toRadians(-120))
                            .setReversed(false)
            ...
            case 0: // Left
                Actions.runBlocking(
                        drive.actionBuilder(drive.pose)
                            .setReversed(true)
                            .splineTo(new Vector2d(-27, 30), Math.toRadians(-45))
                            .setReversed(false)
                            .splineTo(new Vector2d(-48, 42), Math.toRadians(180))
                            .build());
                break ;
