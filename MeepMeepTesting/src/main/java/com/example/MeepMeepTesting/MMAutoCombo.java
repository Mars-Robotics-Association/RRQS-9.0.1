...
public class MMAutoCombo {
    ...
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder( new Pose2d(startX, START_Y * colorModifier, Math.toRadians(90) * colorModifier))
                ...
                // Frontstage
                .splineTo(new Vector2d(-58, 34 * colorModifier), Math.toRadians(-90) * colorModifier)
                .splineTo(new Vector2d(-36, 12 * colorModifier), Math.toRadians(0) )
